...
> LiveData
  - A huge problem with LiveData was its inability to be observed without passing a LifecycleOwner to it. So I had to use the MediatorLiveData and Transformations to be able to work around that issue.# Decade Of Movies
